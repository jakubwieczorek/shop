...
//import wieczorek.jakub.shop.business.spring.model.domain.v1.DeliveryU;
//import wieczorek.jakub.shop.business.spring.model.domain.v1.DeliveryCompanyU;
//
...
//
//        // when
//        DeliveryU delivery = entityManager.getEntityManager().createQuery("select d from DeliveryU d where d.deliveryTime = :deliveryTime", DeliveryU.class)
...
//    {
//        DeliveryCompanyU deliveryCompany = new DeliveryCompanyU();
//        deliveryCompany.setDeliveryCompanyName("aa");
//
//        DeliveryU delivery = new DeliveryU();
