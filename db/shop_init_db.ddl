...
CREATE INDEX subcategory_id_idx ON
    category (
        subcategory_id
    ASC );
...
CREATE INDEX picture_id_idx ON
    product (
        picture_id
    ASC );
...
ALTER TABLE category
    ADD CONSTRAINT category_category_fk FOREIGN KEY ( subcategory_id )
...
ALTER TABLE product
    ADD CONSTRAINT product_picture_fk FOREIGN KEY ( picture_id )
