...
CREATE TABLE category (
    ...
    parent_category_name  VARCHAR2(30 CHAR)
);

CREATE INDEX parent_category_name_idx ON
    category (
...
ALTER TABLE orders ADD CONSTRAINT order_pk PRIMARY KEY ( customer_email,
                                                         order_id );
...
ALTER TABLE picture
    ADD CONSTRAINT picture_pk PRIMARY KEY ( category_name,
                                            product_id,
                                            picture_name );
...
ALTER TABLE product ADD CONSTRAINT product_pk PRIMARY KEY ( category_name,
                                                            product_id );
...
CREATE INDEX order_customer_idx ON
    product_order (
        customer_email
    ASC,
        order_id
...
ALTER TABLE product_order
    ADD CONSTRAINT product_order_pk PRIMARY KEY ( category_name,
                                                  product_id,
                                                  customer_email,
                                                  order_id );
...
CREATE TABLE promotion (
    ...
    product_category_name  VARCHAR2(30 CHAR)
);

ALTER TABLE promotion
    ADD CONSTRAINT one_promotion CHECK ( ( ( category_name IS NOT NULL )
...
CREATE INDEX promotion_category_name_idx ON
    promotion (
        category_name
    ASC );
...
ALTER TABLE category
    ADD CONSTRAINT category_category_fk FOREIGN KEY ( parent_category_name )
...
ALTER TABLE complaints_for_orders
    ADD CONSTRAINT complaints_for_orders_order_fk FOREIGN KEY ( order_customer_email,
                                                                order_id )
        REFERENCES orders ( customer_email,
                            order_id )
            ON DELETE CASCADE;
...
ALTER TABLE picture
    ADD CONSTRAINT picture_product_fk FOREIGN KEY ( category_name,
                                                    product_id )
        REFERENCES product ( category_name,
                             product_id )
            ON DELETE CASCADE;

ALTER TABLE product
    ADD CONSTRAINT product_category_fk FOREIGN KEY ( category_name )
        REFERENCES category ( category_name );
...
ALTER TABLE product_order
    ADD CONSTRAINT product_order_product_fk FOREIGN KEY ( category_name,
                                                          product_id )
        REFERENCES product ( category_name,
                             product_id )
            ON DELETE CASCADE;
...
ALTER TABLE promotion
    ADD CONSTRAINT promotion_category_fk FOREIGN KEY ( category_name )
        REFERENCES category ( category_name )
            ON DELETE CASCADE;
...
ALTER TABLE promotion
    ADD CONSTRAINT promotion_product_fk FOREIGN KEY ( product_category_name,
                                                      product_id )
        REFERENCES product ( category_name,
                             product_id )
            ON DELETE CASCADE;
...
CREATE OR REPLACE TRIGGER fkntm_product_order BEFORE
     UPDATE OF category_name, product_id, customer_email, order_id ON product_order FOR EACH ROW
    WHEN (new.category_name <> old.category_name or
